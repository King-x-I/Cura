...
import { MapPin, Calendar as CalendarIcon, Clock, FileUp, Loader2 } from "lucide-react";
...
const CaretakerService = () => {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    // Mock API call to book a caretaker
    setTimeout(() => {
      setBooking(true);
          ...
          <CardContent className="pt-6">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="babysitter">Babysitting</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
                ...
                <div className="space-y-2">
                  <FormLabel>Optional Document</FormLabel>
                  <div className="border-2 border-dashed border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-gray-500 mb-2 text-center">
                      Upload any relevant medical documents or instructions
                    </p>
                    <Input 
                      type="file" 
                      className="max-w-xs"
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="text-sm text-gray-600">
                    Pricing varies based on care type, duration, and specific requirements. You will receive the final price after a caretaker accepts your booking.
                  </div>
                </div>
                
                <Button type="submit" className="w-full" disabled={isLoading}>
                  {isLoading ? "Processing..." : "Request a Caretaker"}
                </Button>
              </form>
            </Form>
          </CardContent>
