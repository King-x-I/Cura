...
const HouseHelperService = () => {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    // Mock API call to book a house helper
    setTimeout(() => {
      setBooking(true);
                      ...
                      <FormControl>
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            ...
                            <label htmlFor="cleaning" className="cursor-pointer">Cleaning</label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="cooking" id="cooking" />
                            <label htmlFor="cooking" className="cursor-pointer">Cooking</label>
                          </div>
                          <div className="flex items-center space-x-2">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Textarea 
                            placeholder="Any special tools needed or requirements..."
